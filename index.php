...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">EMC Faculty</a>
...
<div class="container">
   <div class="row justify-content-center">
       <div class="col-md-6">
        ...
        <div class="card mt-5">
            <div class="card-body">
                <form class="" method="POST" action="<?= $helper->baseUrl('upload.php') ?>"  enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input required type="file" class="form-control-file"  name="uploadedFile" aria-describedby="fileHelp">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>* Uploader's Name</label>
                                    <input required type="text" class="form-control"  name="uploader"  placeholder="Enter uploader's name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Preferred filename (Optional)</label>
                                    <input type="text" class="form-control" name="filename"  placeholder="Filename (Optional)">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
